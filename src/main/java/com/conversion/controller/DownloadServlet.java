...
/** Servlet pour télécharger les fichiers convertis.
 Endpoint: /download?id=...
 */
@WebServlet(name = "DownloadServlet", urlPatterns = {RouteConstants.API_DOWNLOAD})
public class DownloadServlet extends BaseController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.info("Fichier téléchargé: {} par utilisateur: {}", 
